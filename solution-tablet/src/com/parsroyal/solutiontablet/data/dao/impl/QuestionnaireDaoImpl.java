 ...
 */
public class QuestionnaireDaoImpl extends AbstractDao<Questionnaire, Long> implements QuestionnaireDao
{
    ...
    protected ContentValues getContentValues(Questionnaire entity)
    {
        ...
        contentValues.put(Questionnaire.COL_CUSTOMER_GROUP_BACKEND_ID, entity.getCustomerGroupBackendId());
    ...
    public List<QuestionnaireListModel> searchForQuestionnaires(QuestionnaireSo questionnaireSo)
    {
        ...
        Cursor cursor = db.query(table, projection, selection, argList.toArray(args), groupBy, null, orderBy);
