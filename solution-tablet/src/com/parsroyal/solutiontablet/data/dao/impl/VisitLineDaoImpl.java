...
public class VisitLineDaoImpl extends AbstractDao<VisitLine, Long> implements VisitLineDao
{
    ...
    {
        String[] projection = {VisitLine.COL_ID, VisitLine.COL_BACKEND_ID, VisitLine.COL_CODE, VisitLine.COL_TITLE};
        return projection;
    }
    ...
    public List<VisitLineListModel> getAllVisitLineListModel()
    {
        ...
        String sql = "select vl.BACKEND_ID, vl.CODE, vl.TITLE,count(cu._id) COUNT from COMMER_VISIT_LINE vl " +
