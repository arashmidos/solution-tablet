...
public class NewCustomerPicDataTransferBizImpl extends AbstractDataTransferBizImpl<String>
{
    ...
    public void exchangeData()
    {
        ...
        try
        {
            ...
            ResponseEntity<String> response = restTemplate.exchange(url, getHttpMethod(), requestEntity, getType());
    ...
    public void receiveData(String data)
    {
        if (data.equals("1"))
        {
            ...
            getObserver().publishResult(context.getString(R.string.new_customers_pic_transferred_successfully));
        } else
        {
