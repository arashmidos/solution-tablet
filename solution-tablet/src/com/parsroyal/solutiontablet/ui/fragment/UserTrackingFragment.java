        ...
        GoogleMap.OnCameraChangeListener, DateSetListener
{
    ...
    private void doEnter()
    {
        try
        {
            ...
            orderService.deleteForAllCustomerOrdersByStatus(clickedClusterItem.getBackendId(), SaleOrderStatus.DRAFT.getId());
            Bundle args = new Bundle();
    ...
    {
        List<CustomerListModel> customerPositionList = customerService.getFilteredCustomerList(null, null);
    ...
    class CustomRenderer extends DefaultClusterRenderer<CustomerListModel>
    {
        ...
        @Override
        protected void onBeforeClusterItemRendered(CustomerListModel item, MarkerOptions markerOptions)
        {
