...
public class AddCustomerFragment extends BaseFragment {
  ...
  @BindView(R.id.state_spinner) Spinner stateSpinner;
  @BindView(R.id.ownership_spinner) Spinner ownershipSpinner;
  @BindView(R.id.activity_spinner) Spinner activitySpinner;
  @BindView(R.id.customer_class_spinner) Spinner customerClassSpinner;
    ...
    ArrayAdapter<String> adapter = new ArrayAdapter<String>(activity, android.R.layout.simple_spinner_dropdown_item) {
      ...
      public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == getCount()) {
          ...
          ((TextView) v.findViewById(android.R.id.text1)).setHintTextColor(ContextCompat.getColor(activity, android.R.color.black));
