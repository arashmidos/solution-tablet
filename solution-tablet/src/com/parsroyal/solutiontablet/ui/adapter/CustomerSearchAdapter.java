...
public class CustomerSearchAdapter extends RecyclerView.Adapter<CustomerSearchAdapter.ViewHolder> {
  ...
  private static final String TAG = CustomerSearchAdapter.class.getName();
  ...
  public CustomerSearchAdapter(Context mainActivity,
      CustomerSearchDialogFragment customerSearchDialogFragment, List<CustomerListModel> customers,
      long visitlineBackendId) {
    this.mainActivity = (MainActivity) mainActivity;
    this.customers = customers;
    this.customerSearchDialogFragment = customerSearchDialogFragment;
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private void showCustomerDetailDialog() {
      ...
      model.setVisitlineBackendId(model.getBackendId());
      if (MultiScreenUtility.isTablet(mainActivity)) {
        customerInfoDialogFragment = CustomerInfoBottomSheet
            .newInstance(null, model, position);
      } else {
        customerInfoDialogFragment = CustomerInfoDialogFragment
            .newInstance(null, model, position);
      }
