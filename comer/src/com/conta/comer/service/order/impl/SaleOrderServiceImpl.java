package com.conta.comer.service.order.impl;
...
import com.conta.comer.exception.SaleOrderItemCountExceedExistingException;
...
public class SaleOrderServiceImpl implements SaleOrderService
{
    ...
    {
        List<SaleOrderItemDto> allOrderItemsDtoByOrderId = saleOrderItemDao.getAllOrderItemsDtoByOrderId(orderId);
    ...
    {
        SaleOrderDto orderDto = saleOrderDao.getOrderDtoByCustomerBackendIdAndStatus(backendId, statusId);
    ...
    @Override
    public SaleOrderItem findOrderItemByOrderIdAndGoodsBackendId(Long id, long goodsBackendId, long invoiceBackendId)
    {
    ...
    public void deleteForAllCustomerOrdersByStatus(Long customerBackendId, Long statusId)
    {
        ...
        {
            List<SaleOrderItemDto> allOrderItemsDtoByOrderId = saleOrderItemDao.getAllOrderItemsDtoByOrderId(order.getId());
            for (SaleOrderItemDto saleOrderItemDto : allOrderItemsDtoByOrderId)
            {
    ...
    @Override
    public void updateOrderItemCount(Long itemId, Double count, Long selectedUnit, Long orderStatus, Goods localGood)
    {
        SaleOrderItem orderItem = saleOrderItemDao.retrieve(itemId);
        Goods goods = null;
