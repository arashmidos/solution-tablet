...
import com.conta.comer.exception.GPSIsNotEnabledException;
...
public class LocationServiceImpl implements LocationService, LocationListener
{
    ...
    private void requestForLocation()
    {
        ...
        if (allProviders.contains(LocationManager.GPS_PROVIDER) && locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER))
        {
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);
        }
        if (allProviders.contains(LocationManager.NETWORK_PROVIDER) && locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER))
        {
