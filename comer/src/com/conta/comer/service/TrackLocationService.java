        ...
        GoogleApiClient.OnConnectionFailedListener, LocationListener
{
    ...
    public void onCreate()
    {
        ...
        try
        {
            salesmanId = Long.parseLong(keyValueDao.retrieveByKey(ApplicationKeys.SALESMAN_ID).getValue());

            interval = Integer.valueOf(settingService.getSettingValue(ApplicationKeys.SETTING_GPS_INTERVAL));
    ...
    public int onStartCommand(Intent intent, int flags, int startId)
    {
        ...
        Log.d(TAG, "Service Started with intent" + (intent == null ? "Null" : intent.getExtras().toString()));
    ...
    private void saveLocationToDb(Location l)
    {
        ...
        Log.d(TAG, "Exact Location:" + l.getLatitude() + "-" + l.getLongitude() + "Provider" + l.getProvider());
        try
        {
