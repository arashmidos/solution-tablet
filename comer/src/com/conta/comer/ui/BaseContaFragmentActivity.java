 ...
 */
public class BaseContaFragmentActivity extends FragmentActivity
{

    public static final String TAG = BaseContaFragmentActivity.class.getSimpleName();
    ...
    public void toastError(ContaBusinessException ex)
    {
